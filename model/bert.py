...
from model.zixing_bert import GlyceBertModel
from .crf import CRF
...
class BERTforNER_CRF(BertPreTrainedModel):
    ...
    def forward(self, input_ids, attention_mask=None, token_type_ids=None, pred_mask=None, input_labels=None,zixing_ids=None):
        '''
