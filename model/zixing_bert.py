...
from model.fusion_embedding import FusionBertEmbeddings
...
class GlyceBertModel(BertModel):
    ...
    def forward(
        ...
        if position_ids is None:
            ...
            position_ids1 = []
            position_ids = []
            for i in attention_mask.cpu().numpy().tolist():
                if max < len(i):
                    max = len(i)
                position_ids2 = []
                t = 1
        ...
        embedding_output = self.embeddings(
            input_ids=input_ids,zixing_ids=zixing_ids, position_ids=position_ids, token_type_ids=token_type_ids,
