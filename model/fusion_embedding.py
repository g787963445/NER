...
from getweibozixingid import get_all_word2id
...
class FusionBertEmbeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.glyph_embeddings = GlyphEmbedding(embedding_size=config.hidden_size,zixing_out_dim=config.hidden_size)

        # self.LayerNorm is not snake-cased to stick with TensorFlow models variable name and be able to load
        # any TensorFlow checkpoint file
        # self.glyph_map = nn.Linear(1536, config.hidden_size)
    ...
    def forward(self, input_ids=None,zixing_ids=None,token_type_ids=None, position_ids=None,inputs_embeds=None):
