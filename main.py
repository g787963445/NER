...
if __name__ == "__main__":
    ...
    # file path
    parser.add_argument('--train_file', type=str, default='./datas/train.txt')
    parser.add_argument('--dev_file', type=str, default='./datas/dev.txt')
    parser.add_argument('--test_file', type=str, default='./datas/test.txt')
    parser.add_argument('--word2id_file', type=str, default='./datas/word2id.json')
